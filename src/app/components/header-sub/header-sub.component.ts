...
@Component({
  ...
  styleUrl: './header-sub.component.css'
})
export class HeaderSubComponent implements OnInit, AfterViewInit {
  @Input() classPara: any;
  userName:any;
    ...
    if (location == "uae" || location == 'null') {
      if (this.homeSearchService.fieldName == "subcategory") {
        this._router.navigate(
          [
            //"subcategory",
            //this.homeSearchService.fieldDetails.categoryName.trim().toLowerCase().replace(/[ ,]/g, "-"),
           // this.homeSearchService.fieldDetails.subCategoryName.trim().toLowerCase().replace(/[ ,]/g, "-"),
      ...
      if (this.homeSearchService.fieldName == "subcategory") {
        this._router.navigate(
          [
            //"subcategory",this.homeSearchService.fieldDetails.categoryName.trim().toLowerCase().replace(/[ ,]/g, "-"),
            //this.homeSearchService.fieldDetails.subCategoryName.trim().toLowerCase().replace(/[ ,]/g, "-"),location,
            //this.homeSearchService.fieldDetails.id,
            this.urlService.getSubcategoryLocUrl(this.homeSearchService.fieldDetails.categoryName,
              this.homeSearchService.fieldDetails.subCategoryName,location,this.homeSearchService.fieldDetails.id)
          ],
          { queryParams: {} }
        );
      } else if (this.homeSearchService.fieldName == "seller") {
